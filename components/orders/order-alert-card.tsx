...
const defaultAlerts: OrderAlert[] = [
  {
    id: "1",
    priority: "critical",
    title: "High-value order pending for 4+ hours",
    description: "Order ORD-2847 worth $890.00 has been pending payment confirmation for over 4 hours.",
    estimatedImpact: "Potential revenue at risk: $890",
  },
  {
    id: "2",
    priority: "high",
    title: "Payment failed for mobile user",
    description: "3 orders from mobile users failed payment in the last hour. Payment gateway timeout suspected.",
    estimatedImpact: "Lost revenue: $1,240",
  },
  {
    id: "3",
    priority: "medium",
    title: "Shipping delayed for 12 orders",
    description: "Carrier API returned errors. 12 orders are stuck in 'processing' status.",
    estimatedImpact: "Customer satisfaction impact",
  },
  {
    id: "4",
    priority: "medium",
    title: "Refund requested for Order ORD-2843",
    description: "Customer requested refund for damaged product. Refund amount: $67.00.",
    estimatedImpact: "Refund cost: $67.00",
  },
];
